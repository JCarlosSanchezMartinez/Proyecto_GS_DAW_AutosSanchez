...
const routes: Routes = [ 
      ...
      {path: 'user', component: SearchClientComponent,canActivate: [guard], data: { expectedRol: ['admin']}},
      {path: 'newUser', component: NewUserComponent,canActivate: [guard], data: { expectedRol: ['admin']}},
      {path: 'user/:id', component: ClientManagementComponent,canActivate: [guard], data: { expectedRol: ['admin']}},
